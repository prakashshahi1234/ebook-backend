...
const { uploadBook, deleteAnyFile, serveBook, uploadBookCover, uploadProfilePic, uploadProfileCoverPic, loadBook, uploadIdentityImage } = require("../controller/fileuploadController");
...
router.route("/upload-identity-image").get(isAuthenticatedUser  ,uploadIdentityImage)
